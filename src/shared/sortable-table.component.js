...
export default class SortableTable {
    ...
    constructor(container, config) {
        ...
        this.sortAsc = config.initialSortAsc !== undefined ? config.initialSortAsc : true;
        ...
        if (this.data.length === 0) {
            ...
            this.data.forEach(item => {
                ...
                if (this.enableSelection) {
                    ...
                    checkbox.addEventListener('change', (e) => this.handleRowSelect(item.row, e.target.checked));
    ...
    sortData() {
        ...
        this.data.sort((a, b) => {
            ...
            } else if (colDef && (colDef.type === 'number' || colDef.type === 'currency')) {
    ...
    handleSelectAll(checked) {
        ...
        if (this.onSelectionChange) this.onSelectionChange(Array.from(this.selectedRows));
        this.render();
    }
